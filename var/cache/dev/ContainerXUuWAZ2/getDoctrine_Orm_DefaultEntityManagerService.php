...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\UserinfoRepository' => function () {
    return ($this->privates['App\Repository\UserinfoRepository'] ?? $this->load('getUserinfoRepositoryService.php'));
